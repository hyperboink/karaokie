    ...
    <div className="flex flex-col landscape:flex-row desk:flex-row h-dvh bg-gray-950 text-white overflow-hidden">
      ...
      <nav className="desk:hidden landscape:hidden shrink-0 relative flex items-stretch border-t border-gray-800 bg-gray-900 pb-safe">
        ...
        <button
          ...
          className={`flex-1 flex flex-col items-center justify-center py-3 gap-0.5 text-xs font-medium transition-colors ${mobileTab === 'stage' ? 'text-yellow-400' : 'text-gray-400 active:text-gray-200'}`}
        ...
        <button
          ...
          className={`flex-1 flex flex-col items-center justify-center py-3 gap-0.5 text-xs font-medium transition-colors ${mobileTab === 'queue' ? 'text-yellow-400' : 'text-gray-400 active:text-gray-200'}`}
